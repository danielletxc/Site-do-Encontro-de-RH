...
import { Clock, User, Zap, Coffee, Scale, Church, Utensils, GlassWater, Users, MapPin, Check, BrainCircuit, Play, BrainIcon, Brain, Sun } from 'lucide-react';
import { motion } from 'motion/react';

import { TabId } from '../../types';

interface Dia02Props {
  onNavigate?: (tab: TabId) => void;
}

const Dia02: React.FC<Dia02Props> = ({ onNavigate }) => {
  ...
  const schedule = [
    { time: '08:00', icon: <Church />, title: 'Culto semanal', desc: 'Reforçando nossos valores.', location: 'Auditório Torre Forte - Unidade ES', badge: 'Valores' },
    { time: '08:30', icon: <Coffee />, title: 'Coffee Break', desc: 'Energia para começar.', location: 'Praça Azul', isBreak: true, badge: 'Pausa' },
    { time: '09:00', icon: <Play />, title: 'Abertura do Encontro', desc: 'com Robson Gramacho.', location: 'Auditório Brasil - Sede Corporativa', badge: 'Abertura' },
    { time: '09:30', icon: <BrainCircuit />, title: 'Treinamento de IA aplicado ao RH', desc: 'com William Mazza.', location: 'Auditório Brasil - Sede Corporativa', badge: 'Tecnologia' },
    { time: '12:00', icon: <Utensils />, title: 'Almoço', desc: 'Destinar-se ao refeitório.', location: 'Refeitório da Unidade ES', badge: 'Pausa', isBreak: true },
    { time: '13:00', icon: <Users />, title: 'Treinamento sobre comunicação', desc: 'com Cosme Peres', location: 'Auditório Brasil - Sede Corporativa', badge: 'Soft Skills' },
    { time: '15:30', icon: <Coffee />, title: 'Coffee Break', desc: 'Uma pausa para recarregar as energias.', location: 'Praça Azul', badge: 'Pausa', isBreak: true },
    { time: '16:00', icon: <Users />, title: 'Treinamento sobre comunicação', desc: 'com Cosme Peres', location: 'Auditório Brasil - Sede Corporativa', badge: 'Soft Skills' },
    { time: '18:00', icon: <Scale />, title: 'Alinhamento com Jurídico', desc: 'com Dr. Renan Silva e Robson Gramacho.', location: 'Auditório Brasil - Sede Corporativa', badge: 'Processos' },
    { 
      time: '19:00', 
      icon: <GlassWater />, 
      title: 'Happy Hour', 
      desc: 'Encerramento do primeiro dia.', 
      location: 'Petisco das Meninas - Manguinhos, Serra - ES', 
      badge: 'Social',
      link: 'https://maps.app.goo.gl/TLeQV7G6BvH8e48x7' // Placeholder link, user will update
    },
  ];
  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="text-center mb-12">
        ...
        <h2 className="text-3xl md:text-5xl font-yellowtail text-[#FF6F00] drop-shadow-lg mb-2">Segunda-feira</h2>
        <p className="text-gray-400 text-xs md:text-sm font-light tracking-wide">02 de Março - Foco em Alinhamento e Futuro</p>
      </motion.div>
                          ...
                          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-3 gap-y-2 mt-3">
                            ...
                            {item.link && (
                              <a 
                                ...
                                className="flex items-center gap-1 px-2 py-1 rounded-md bg-[#FF6F00]/10 hover:bg-[#FF6F00]/20 border border-[#FF6F00]/30 transition-colors group/link"
                                onClick={(e) => e.stopPropagation()}
                              >
                                <MapPin size={10} className="text-[#FF6F00]" />
                                <span className="text-[9px] font-bold text-[#FF6F00] uppercase tracking-wider">Ver no mapa</span>
                              </a>
                            )}
                          </div>
                        </div>
        ...
        <motion.div variants={itemVariants} className="pt-12">
          ...
          >
             ...
             <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
               {[
                 { name: 'William Mazza', role: 'IA no RH', img: 'https://i.ibb.co/tptY1zPR/William-Mazza.jpg' },
                 { name: 'Cosme Péres', role: 'Comunicação', img: 'https://i.ibb.co/Sw7ZppTw/Cosme-P-res.jpg' },
                 { name: 'Renan Silva', role: 'Jurídico', img: 'https://iili.io/fbsYhfR.md.webp' }
               ].map((speaker, i) => (
